...
import com.example.personator.adapters.PinnedNewsAdapter;
...
import static com.example.personator.common.Common.SHARED_PREFERENCES_NAME;

public class LatestNews extends Fragment implements View.OnClickListener,
        NewsAdapter.ImageClickListener, PinnedNewsAdapter.PinnedClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Thread tr = new Thread(() -> checkForUpdates());
        tr.start();
    ...
    public void clicked(int code) {
        getActivity().getSupportFragmentManager()
                .beginTransaction()
                .replace(R.id.id_container, NewsDetalis.newInstance(code))
                .addToBackStack(null)
                .commit();
    }
